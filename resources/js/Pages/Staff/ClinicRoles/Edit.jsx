...
export default function Edit({ clinicRole, clinics, roles }) {
    ...
    return (
        <StaffLayout header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">クリニック別ロール編集</h2>}>
                        ...
                        <div className="p-6 bg-white border-b border-gray-200">
                            <form onSubmit={submit}>
                                ...
                                <div className="flex justify-end">
                                    <button type="submit" disabled={processing} className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">更新</button>
                                </div>
                            </form>
                        </div>
                    </div>
